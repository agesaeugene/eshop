...
// Proper type for form data (not native FormData)
...
const SignupContent = () => {
  ...
  // Removed unused rememberMe state
  const [userData, setUserData] = React.useState<SignupFormData | null>(null);
  ...
  // Fixed: was empty — now re-triggers the signup mutation with saved userData
  const resendOtp = () => {
    if (!userData) return;
    setServerError(null);
    setCanResend(false);
            ...
            {!showOtp ? (
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 mb-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
