...
const ProductList = () => {
        ...
        () => [
            {
                ...
                cell: ({ row }: any) => (
                    <Image
                        ...
                        alt={row.original.images?.[0]?.url ? row.original.title : "product image"}
                        width={200}
                        height={200}
                ...
                cell: ({ row }: any) => {
                    ...
                    return (
                        <Link
                            ...
                            className='text-blue-400 hoover:underline'
    ...
    return (
        <div className=' w-full main-h-screen p-8'>
            {/* Header */}
            ...
            <div className="mb-4 flex items-center bg-gray-900 p-2 rounded-md flex-1">
                ...
                <input
                    ...
                    className='w-full bg-transparnt text-white outline-none'
                    value={globalFilter}
