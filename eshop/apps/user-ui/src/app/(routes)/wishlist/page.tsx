        ...
        <div className="w-full bg-white">
            <div className="md:w-[80%] w-[95%] mx-auto min-h-screen">
                ...
                <div className="pb-[50px]">
                    <h1 className="md:pt-[50px] font-medium text-[44px] leeding-[1] mb-[16px] font-jost">
                        Wishlist
                    </h1>
                    ...
                    <span className="text-[#55585b] rounded-full">Wishlist</span>
                </div>
                        ...
                        <table className="w-full border-collapse">
                            <thead className="bg-[#f1f3f4]">
                                <tr>
                                    ...
                                    <th className="py-3 text-left pl-4">Price</th>
                                    <th className="py-3 text-left pl-4">Quantity</th>
                                    <th className="py-3 text-left pl-4">Action</th>
