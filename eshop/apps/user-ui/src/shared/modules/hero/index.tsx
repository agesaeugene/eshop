...
const Hero = () => {
  ...
  return (
    <div className="bg-[#115061] h-[85vh] flex flex-col justify-center w-full">
      <div className="w-[90%] m-auto md:flex h-full items-center">
        <div className="md:w-1/2">
          ...
          <button
            ...
            className="flex items-center gap-2 font-semibold text-white hover:text-yellow-400 transition-colors"
          >
            Shop Now <MoveRight />
          </button>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src={layout?.banner || "https://ik.imagekit.io/eugenesokojamo/products/hero-banner.svg"}
            alt="Hero banner"
            width={450}
            height={450}
          />
